  ...
  public class Program
  {
    ...
    public void CreateScene()
    {
      ...
      //mEngine.Camera.Roll(new Radian(new Degree(180)));
        ...
        var matProj = new Matrix4(4.19381122389134f, 0f, 0.1653409798007381f, 0,
0, 6.120329049336069f, -1.459515732682093f, 0,
0, 0, -1.02020202020202f, -0.202020202020202f,
0, 0, -1f, 0);

        var matView = new Matrix4(0.9977219354561994f, 0.0203332201925092f, 0.06432339905616413f, -0.0435735942822164f,
0.006990103071024832f, 0.9172025684798273f, -0.3983598710124603f, 0.06720984985901518f,
0.06709752580082257f, -0.397902008703915f, -0.9149709905241792f, -0.03889246386135171f,
0, 0, 0, 1f);
